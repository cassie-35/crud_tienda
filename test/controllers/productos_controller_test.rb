...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id, stock: @producto.stock } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, nombre: @producto.nombre, precio: @producto.precio, proveedor_id: @producto.proveedor_id, stock: @producto.stock } }
